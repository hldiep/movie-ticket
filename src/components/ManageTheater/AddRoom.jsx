        ...
        <ClippedDrawer>
            <div className="sticky top-16 z-10 bg-white border-b shadow-sm">
                <div className="flex items-center text-sm text-gray-600 space-x-2 px-4 pt-2">
                    ...
                    <span>/</span>
                    <button
                        onClick={() => navigate('/quan-ly-rap/them-rap')}
                        className="hover:underline text-blue-600"
                    >
                        Thêm rạp
                    </button>
                    <span>/</span>
                    <span className="text-gray-700 font-medium">Thêm phòng chiếu</span>
                </div>
                <h2 className="text-xl font-semibold p-4">Thêm phòng chiếu</h2>
            </div>
            <div className='min-h-screen bg-gray-50'>
                <div className='container'>
                    <div className="p-6 font-sans text-black">

                        <h2 className="text-lg font-semibold">Chọn sơ đồ ghế</h2>
