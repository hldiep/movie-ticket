...
const ListMovie = () => {
    ...
    const fetchMoviesByStatus = async (status) => {
        try {
            const response = await axios.get(`http://localhost:8080/film/get/status/${encodeURIComponent(status)}`);
                    ...
                    <div className="p-6">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <div className='space-x-4'>
                                ...
                                <NavLink to="/quan-ly-phim/quan-ly-slider"
                                    className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded text-white transition-transform duration-300 transform hover:scale-105 cursor-pointer">
                                    Quản lý Slider
                                </NavLink>
                            </div>
                        ...
                        <div className="mb-4 text-right">
                            <select className="bg-gray-700 text-white px-4 py-2 rounded outline-none"
                                value={filterStatus}
                                onChange={(e) => {
